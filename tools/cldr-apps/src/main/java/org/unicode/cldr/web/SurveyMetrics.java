...
public class SurveyMetrics {
    @Inject
    @Metric(name = "exceptions", description = "Number of SurveyTool Exceptions that happened")
    ...
    @Gauge(name = "users", description = "Number of active users", unit = MetricUnits.NONE)
    public int getUsers() {
