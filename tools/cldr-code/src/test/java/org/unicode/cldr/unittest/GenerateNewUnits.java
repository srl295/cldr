...
public class GenerateNewUnits {
    private static final String CHECK_UNIT = "abfarad";
...
//            ConversionInfo sourceConversionInfo = converter.parseUnitId(data.source, sourceBase, false);
//
...
//                mark="¹";
//            } else {
//                ConversionInfo conversionInfo = converter.getUnitInfo(data.target, baseUnit);
...
//            }
    ...
    /**
     * Return a simplified unit, eg kilogram-per-meter-square-second ==> pascal
     * TODO handle complex units that don't match a simple quantity, eg kilogram-ampere-per-meter-square-second => pascal-ampere
     * @param unit
     * @return
     */
...
//        return unit;
    ...
    static final Comparator<ExternalUnitConversionData> myComparator = new Comparator<>() {
        @Override
    ...
    private static List<SimpleConversionData> clean(List<ExternalUnitConversionData> externalconversiondata) {
        Multimap<String, ExternalUnitConversionData> cleaned = TreeMultimap.create(Comparator.naturalOrder(), myComparator);
        ...
        ImmutableSet<String> absoluteTemperature = ImmutableSet.of("celsius", "fahrenheit", "kelvin", "rankine");
        Output<String> baseUnit = new Output<>();
        for (Entry<String, Collection<ExternalUnitConversionData>> items : cleaned.asMap().entrySet()) {
    ...
    public static SimpleConversionData findBestMapping(Output<String> baseUnit, final String source, final Collection<ExternalUnitConversionData> mappings) {
...
//            }
        ...
        return new SimpleConversionData(bestQuantity, source, new ConversionInfo(bestFactor, Rational.ZERO), bestTarget);
    }
    ...
    static class SimpleConversionData {
        public SimpleConversionData(String quantity, String source, ConversionInfo conversionInfo, String target) {
...
//    private static ExternalUnitConversionData best(String source, Collection<ExternalUnitConversionData> collection) {
...
//    }
    ...
    static final ImmutableMap<String,String> quantityFromUnit = ImmutableMap.<String,String>builder()
        .put("curie", "radioactivity")
        .put("kayser", "spectroscopy")
        .put("gon", "angle")
        .put("cubic-second-square-ampere-per-kilogram-square-meter", "electrical-conductance")
        ...
        .put("kilogram-square-meter-per-meter-cubic-second-kelvin", "thermal-conductivity")
