...
public class ShowLanguages {
    ...
    static class LanguageInfo {
        ...
        Set<String[]> aliases =
                new TreeSet<String[]>(
                        new ArrayComparator(new Comparator[] {new UTF16.StringComparator(), col}));
        ...
        Map<String, LinkedHashSet<String>> charSubstitutions =
                new TreeMap<String, LinkedHashSet<String>>(col);
            ...
            for (Entry<String, Map<String, R2<List<String>, String>>> entry1 :
                ...
                for (Entry<String, R2<List<String>, String>> entry2 :
                    ...
                    try {
                        localeAliasInfo
                                .get(element)
                                .put(type, replacement == null ? "?" : replacement);
                    } catch (Exception e) {
        ...
        private String addBug(
                int bugNumber, String text, String from, String subject, String body) {
        ...
        private String getVendorStatus(
                String locale,
                Organization vendor,
                Map<Organization, Map<String, Level>> vendordata) {
        ...
        public void printAliases(PrintWriter index) throws IOException {
            PrintWriter pw =
                    new PrintWriter(
                            new FormattedFileWriter(
                                    null, "Aliases", null, SUPPLEMENTAL_INDEX_ANCHORS));
        ...
        public void printWindows_Tzid(PrintWriter index) throws IOException {
            Map<String, Map<String, Map<String, String>>> zoneMapping =
                    supplementalDataInfo.getTypeToZoneToRegionToZone();
            PrintWriter pw =
                    new PrintWriter(
                            new FormattedFileWriter(
                                    null, "Zone \u2192 Tzid", null, SUPPLEMENTAL_INDEX_ANCHORS));
        ...
        public void printContains(PrintWriter index) throws IOException {
            ...
            showSubtable(
                    pw, ContainmentStyle.grouping, "Groupings", "Grouping", "Contained Regions");
            showSubtable(
                    pw,
                    ContainmentStyle.deprecated,
                    "Deprecated",
                    "Container",
                    "Deprecated Region");
        ...
        private void printContains3(
                String start, List<String[]> rows, ArrayList<String> currentRow) {
